...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    double lowOutput = lowPIDController.calculate(intakeLowerMotor.getSelectedSensorVelocity());
    double highOutput = highPIDController.calculate(intakeHigherMotor.getSelectedSensorVelocity());
